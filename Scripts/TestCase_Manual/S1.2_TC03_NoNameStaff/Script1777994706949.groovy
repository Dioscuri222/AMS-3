...
WebUI.sendKeys(findTestObject('TC_AddStaff/input_Position_position'), Posisi)

WebUI.sendKeys(findTestObject('TC_AddStaff/input_Email_email'), Email)
...
WebUI.verifyElementHasAttribute(findTestObject('TC_AddStaff/input_Name_name'), 'required', 
    5)
