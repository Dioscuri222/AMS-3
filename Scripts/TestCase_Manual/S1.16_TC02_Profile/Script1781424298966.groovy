...
WebUI.click(findTestObject('TC_Bahasa/Page_Attendance Management System/a_Profile'))

WebUI.waitForElementVisible(findTestObject('TC_Bahasa/Page_Attendance Management System/a_Profile'), 0)
