...
WebUI.click(findTestObject('TC_Bahasa/Page_Attendance Management System/img_View all_rounded-circle'))

// 2. Klik pada pilihan bahasa Jerman (German) yang muncul
WebUI.click(findTestObject('TC_Bahasa/Page_Attendance Management System/a_Lock screen'))

WebUI.waitForElementVisible(findTestObject('TC_Bahasa/Page_Attendance Management System/a_Lock screen'), 0)
