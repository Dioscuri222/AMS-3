...
WebUI.sendKeys(findTestObject('TC_AddStaff/input_Name_name'), GlobalVariable.NamaStaff)

WebUI.sendKeys(findTestObject('TC_AddStaff/input_Position_position'), GlobalVariable.Position)

WebUI.sendKeys(findTestObject('TC_AddStaff/input_Email_email'), GlobalVariable.EmailStaff)

// Klik kotak dropdown terlebih dahulu
WebUI.click(findTestObject('TC_AddStaff/Select-Schedule'))

// ... (Script awal kamu tetap sama) ...
// Tunggu sampai dropdown Schedule muncul dan bisa diakses
WebUI.waitForElementClickable(findTestObject('TC_AddStaff/Select-Schedule'), 5)

// Gunakan selectOptionByValue karena atribut 'value' pada tag <option> adalah "Pagi"
WebUI.selectOptionByValue(findTestObject('TC_AddStaff/Select-Schedule'), 'Pagi', false)

WebUI.click(findTestObject('TC_AddStaff/button_Submit'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Page_Attendance Management System/Staff_Special_Zidan/Success_Input'), 0)
