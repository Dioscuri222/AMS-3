...
// 2. Navigasi ke Halaman Tambah Alat Biometrik
...
// 3. Mengisi Form Nama dari CSV (Kolom IP Sengaja Dikosongkan)
...
// 4. Logika Validasi Atribut 'required' HTML5 Browser
if (testType == 'REQUIRED_IP') {
    WebUI.verifyElementHasAttribute(findTestObject('TC_Fingerprint/Page_Attendance Management System/input_IP Address_ip'), 
        'required', 5)
}
